  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2">
      <div className="hidden lg:flex flex-col justify-between bg-navy-950 p-10 relative overflow-hidden">
        ...
        <div className="absolute -top-32 -right-32 w-96 h-96 bg-accent-600/20 rounded-full blur-3xl" />
        <div className="absolute bottom-0 left-0 w-80 h-80 bg-primary-600/15 rounded-full blur-3xl" />
        ...
        <div className="relative max-w-md">
          <p className="text-xs font-semibold uppercase tracking-[0.2em] text-accent-400 mb-4">Start free</p>
          <h2 className="text-3xl font-extrabold text-white leading-snug mb-4">
            From resume gaps to interview-ready.
          </h2>
          <p className="text-surface-400 text-sm leading-relaxed">
            Create an account, upload your resume, and run a full AI mock interview with a scored report.
          </p>
        </div>

        <div className="relative flex flex-wrap gap-6 text-xs text-surface-400">
          <span className="flex items-center gap-1.5"><span className="w-1.5 h-1.5 rounded-full bg-emerald-400" />No credit card</span>
          <span className="flex items-center gap-1.5"><span className="w-1.5 h-1.5 rounded-full bg-primary-400" />Instant setup</span>
          <span className="flex items-center gap-1.5"><span className="w-1.5 h-1.5 rounded-full bg-accent-400" />JWT secured</span>
        </div>
      </div>
      ...
      <div className="flex items-center justify-center bg-surface-50 relative overflow-hidden px-4 py-12">
        ...
        <div className="relative w-full max-w-md">
          <div className="text-center mb-8 animate-fade-down">
            ...
            <h1 className="text-2xl font-extrabold text-surface-900 mb-1.5">Create your account</h1>
            <p className="text-sm text-surface-500">Start practicing interviews in minutes</p>
          </div>
